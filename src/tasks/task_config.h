...
* Last Modified : Tue 22 Jan 2013 02:58:09 PM EET
...
TASK_GRAPH_A[0] = {.id = 0, .children_count = 6,   \
    ...
    .dependencies_count = 0, .lock = 1, .mtask = NULL};


TASK_GRAPH_A[1] = {.id = 1, children_count = 3,    \
    .children = { 7, 10, 13 },          \
    .dependencies_count = 2, .lock = 1, .mtask = NULL};
...
TASK_GRAPH_A[16] = {.id = 16, children_count = 4,             \
    ...
    .dependencies_count = 1, .lock = 1, .mtask = NULL};
...
TASK_GRAPH_A[21] = {.id = 21, .children_count = 1,             \
    .children = { 25 },                             \
    .dependencies_count = 3, .lock = 1, .mtask = NULL};
